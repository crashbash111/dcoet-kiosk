    ...
    render() {
        ...
        switch (this.state.mode) {
            ...
            case 1:
                ...
                //console.log(page);
                child = <Create page={ this.state.pageId != -1 ? { ...page, longdesc: ( page != null && page.longdesc == "null" ) ? "" : page.longdesc } : null } categories={ this.props.categories } handleSubmitted={ this.handleSubmitted } handleCancelCreateClick={this.handleCancelCreateClick} />
                break;
            case 2:
